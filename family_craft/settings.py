"""
Django settings for family_craft project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', '#1%87bjiox&^uw)polrvk18diy(g@-&cc+#evzh!8(&$thchph')
...
WSGI_APPLICATION = 'family_craft.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'piotr-wojniak-fc-ms4'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'familycraft@example.com'
else:
